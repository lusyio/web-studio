        ...
        <div class="container video-block">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 m-auto order-sm-2 order-1">
                    ...
                    <p class="video-block-content d-sm-block d-none">Процесс разработки сайта
                        для писательницы Александры Черчень - <a
                            class="video-block-content__link"
                            href="http://cherchen.ru/">cherchen.ru</a>
                        <span>(длительность - 2 минуты)</span></p>
                </div>
                <div class="col-lg-6 col-12 m-auto d-sm-none d-block order-3">
                    <p class="video-block-content">Процесс разработки сайта
                        для писательницы Александры Черчень - <a
                            class="video-block-content__link"
                            href="http://cherchen.ru/">cherchen.ru</a>
                        <span>(длительность - 2 минуты)</span></p>
