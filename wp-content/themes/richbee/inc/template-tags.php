            ...
            <article id="div-comment-<?php comment_ID(); ?>" class="comment-body media mb-5">
                ...
                <div class="media-body">
                    <div class="d-flex">
                        ...
                        <span class="mt-0 h5 align-self-end name-comment"><?php printf(__('%s', 'wp-bootstrap-starter'), sprintf('<span class="fn pull-left">%s</span>', get_comment_author_link())); ?></span>
                        <a class="align-self-end time-comment" href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>">
                            <time datetime="<?php comment_time('c'); ?>">
                                <?php printf(_x('%1$s в %2$s', '1: date, 2: time', 'wp-bootstrap-starter'), get_comment_date(), get_comment_time()); ?>
                            </time>
                        </a>
                        <?php edit_comment_link(__('<span style="margin-left: 5px;" class="glyphicon glyphicon-edit align-self-end"></span> Edit', 'wp-bootstrap-starter'), '<span class="edit-link">', '</span>'); ?>
                    </div>
